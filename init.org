...
#+BEGIN_SRC elisp
  ...
  (use-package key-chord
    :init
    (setq key-chord-one-key-delay 0.7)
    (key-chord-mode 1)
    :config
    (key-chord-define-global "jj" 'undo)
    (key-chord-define-global "qw" 'brust-cycle-whitespace)
    (key-chord-define-global "bf" 'ivy-switch-buffer)
    (key-chord-define-global "bg" 'brust-ace-window))
...
#+END_SRC
*** Delete element of a list by =car=
#+BEGIN_SRC elisp
  (defun brust-list-delete-element (-key -list)
...
#+BEGIN_SRC elisp
  (use-package tex 
    ...
    (key-chord-define LaTeX-mode-map "fd" 'brust-LaTeX-save)
    (key-chord-define LaTeX-mode-map "qc" 'org-ref-helm-insert-cite-link)
    (key-chord-define LaTeX-mode-map "qr" 'reftex-reference)
    (key-chord-define LaTeX-mode-map "qp" (lambda nil (interactive) (insert "^{}") (forward-char -1)))bg
    (key-chord-define LaTeX-mode-map "qd" (lambda nil (interactive) (insert "_{}") (forward-char -1)))
    :bind 
    (:map LaTeX-mode-map
