...
*** Font lock.
#+BEGIN_SRC elisp
  (setq font-lock-support-mode nil);; 'jit-lock-mode)
...
#+BEGIN_SRC elisp
  ...
  ;;      (setq julia-program "~/sources/julia-1.0.3/bin/julia")
  ;;      )
  ;; (when (file-exists-p "~/.emacs.d/lisp/julia-repl/julia-repl.el")
  ;;   (require 'julia-repl)
  ;;   (add-hook 'julia-mode-hook 'julia-repl-mode) ;; always use minor mode
  ;;   (setq julia-repl-executable-records
  ;;         '((compiled "/home/lazycat/sources/julia-1.0.3/bin/julia")))                 ;; compiled from the repository
  ;;   (add-hook 'julia-repl-hook #'julia-repl-use-emacsclient))
#+END_SRC

#+RESULTS:
: ~/sources/julia-1.0.3/bin/julia
*** Key-frequency
#+BEGIN_SRC elisp
