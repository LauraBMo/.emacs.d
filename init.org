...
#+BEGIN_SRC elisp
  (defun brust-create-english-word-file nil
    (when (file-exists-p "~/Dropbox/config/english-words.txt")
      (find-file "~/Dropbox/config/english-words.txt")
      (erase-buffer)
      (insert-file-contents "~/Dropbox/config/english-words-saved.txt")
      (end-of-buffer)
      (insert (if (file-exists-p "~/.aspell.en.pws")
		  (with-temp-buffer
...
#+BEGIN_SRC elisp
  ...
  (setq brust--myregexp-itself
        (regexp-opt
         (cl-loop for -line in (with-temp-buffer
                                 (insert-file-contents "~/.emacs.d/my-regexp.txt")
                                 (split-string (buffer-string) "\n"))
                  collect -line
