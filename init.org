...
**** Bookmarks
 #+BEGIN_SRC elisp
   ...
   (setq mu4e-bookmarks
         `(
           ...
           ,(make-mu4e-bookmark
             :name "Mathuab Inbox"
             :query "maildir:/mathuab/INBOX AND NOT flag:trashed"
             :key ?i)
           ,(make-mu4e-bookmark
             :name "Mathuab Today"
             :query "maildir:/mathuab/Today AND NOT flag:trashed"
             :key ?t)
           ,(make-mu4e-bookmark
             :name "Mathuab Week"
 ...
 #+RESULTS:
 | #s(mu4e-bookmark Mathuab Inbox maildir:/mathuab/INBOX AND NOT flag:trashed 105) | #s(mu4e-bookmark Mathuab Today maildir:/mathuab/Today AND NOT flag:trashed 116) | #s(mu4e-bookmark Mathuab Week maildir:/mathuab/This week AND NOT flag:trashed 119) | #s(mu4e-bookmark Mathuab Month maildir:/mathuab/This Month AND NOT flag:trashed 109) | #s(mu4e-bookmark Drafts flag:draft 100) |
