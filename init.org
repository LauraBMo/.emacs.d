...
#+BEGIN_SRC elisp
  (bind-keys*
   ...
   ("M-s-S-K" . outline-forward-same-level)        ; Forward - same level
   ("M-s-S-I" . outline-backward-same-level))      ; Backward - same level
