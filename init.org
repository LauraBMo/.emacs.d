...
#+BEGIN_SRC elisp
  (use-package whitespace-cleanup-mode
    ...
    :bind ("M-SPC" . brust-cycle-spacing))

  (defun brust-cycle-spacing (&optional n preserve-nl-back)
    "My workaround"
    (interactive "*p")
    (cycle-spacing (if n (- 0 (abs n)) -1) preserve-nl-back 'fast))
#+END_SRC
